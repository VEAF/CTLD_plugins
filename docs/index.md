...
|--------|----------------|----------|----------|
| [Metal FARP](plugins/metal-farp.md) | A metal-helipad FARP | DCS mod `FG_small_Helipad` | [⬇ metal-farp.lua](https://raw.githubusercontent.com/VEAF/CTLD_plugins/master/plugins/metal-farp/src/CTLD_metalFarpScene.lua){ .md-button } |
